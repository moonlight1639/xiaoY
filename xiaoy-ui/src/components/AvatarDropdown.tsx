...
function AvatarDropdown() {
  ...
  return (
    <div ref={ref} style={{ position: "relative" }} onClick={() => setOpen(!open)}>
      {/* <img
      ...
      <div className="user-info" >
       <span className="user-name">{user?.username || '游客'}</span>
